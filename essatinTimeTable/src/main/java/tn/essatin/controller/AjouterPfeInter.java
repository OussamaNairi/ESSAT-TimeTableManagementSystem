...
/**
 * Servlet implementation class AjouterPfeInter
 */
@WebServlet("/AjouterPfeInter")
public class AjouterPfeInter extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjouterPfeInter() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("ajouterPfe.jsp").forward(request, response);
	}
