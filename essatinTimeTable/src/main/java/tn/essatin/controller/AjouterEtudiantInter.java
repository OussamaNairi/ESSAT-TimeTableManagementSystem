...
/**
 * Servlet implementation class AjouterEtudiantInter
 */
@WebServlet("/AjouterEtudiantInter")
public class AjouterEtudiantInter extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjouterEtudiantInter() {
        super();
