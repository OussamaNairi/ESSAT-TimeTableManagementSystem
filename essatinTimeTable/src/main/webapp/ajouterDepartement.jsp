...
<%@include file="header.jsp" %>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ajouter une departement</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
             <div class="row">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    <label >Chef de departement</label>
    <input type="text" class="form-control" name="chefDepartement" placeholder="Chef departement">
  </div>
